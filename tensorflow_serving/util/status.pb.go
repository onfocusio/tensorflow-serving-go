...
func (x *StatusProto) Reset() {
	*x = StatusProto{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tensorflow_serving_util_status_proto_msgTypes[0]
...
func (*StatusProto) Descriptor() ([]byte, []int) {
	return file_tensorflow_serving_util_status_proto_rawDescGZIP(), []int{0}
}
...
var file_tensorflow_serving_util_status_proto_rawDesc = []byte{
	0x0a, 0x24, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x5f, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x6e, 0x67, 0x2f, 0x75, 0x74, 0x69, 0x6c, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	0x61, 0x67, 0x65, 0x42, 0x03, 0xf8, 0x01, 0x01, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_tensorflow_serving_util_status_proto_rawDescOnce sync.Once
	file_tensorflow_serving_util_status_proto_rawDescData = file_tensorflow_serving_util_status_proto_rawDesc
)

func file_tensorflow_serving_util_status_proto_rawDescGZIP() []byte {
	file_tensorflow_serving_util_status_proto_rawDescOnce.Do(func() {
		file_tensorflow_serving_util_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_tensorflow_serving_util_status_proto_rawDescData)
	})
	return file_tensorflow_serving_util_status_proto_rawDescData
}

var file_tensorflow_serving_util_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_tensorflow_serving_util_status_proto_goTypes = []interface{}{
	(*StatusProto)(nil),                // 0: tensorflow.serving.StatusProto
	(for_core_protos_go_proto.Code)(0), // 1: tensorflow.error.Code
}
var file_tensorflow_serving_util_status_proto_depIdxs = []int32{
...
func init() { file_tensorflow_serving_util_status_proto_init() }
func file_tensorflow_serving_util_status_proto_init() {
	if File_tensorflow_serving_util_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_tensorflow_serving_util_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_tensorflow_serving_util_status_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_tensorflow_serving_util_status_proto_goTypes,
		DependencyIndexes: file_tensorflow_serving_util_status_proto_depIdxs,
		MessageInfos:      file_tensorflow_serving_util_status_proto_msgTypes,
	}.Build()
	File_tensorflow_serving_util_status_proto = out.File
	file_tensorflow_serving_util_status_proto_rawDesc = nil
	file_tensorflow_serving_util_status_proto_goTypes = nil
	file_tensorflow_serving_util_status_proto_depIdxs = nil
}
